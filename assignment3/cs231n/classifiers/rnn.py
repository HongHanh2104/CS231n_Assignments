...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # 1. compute the initial hidden state of RNN from image features
        h0 = features.dot(W_proj) + b_proj

        # 2. word embedding
        x, cache_embeded = word_embedding_forward(captions_in, W_embed)
        ...
        # 2. word embedding backprop
        dW_embedded = word_embedding_backward(dx, cache_embeded)
    ...
    def sample(self, features, max_length=30):
        ...
        V, W = W_embed.shape
        # initial hidden state from input image figures
